...
<p align="center">
  <img src="app/src/main/res/drawable/ic_visual_search.xml" width="80" height="80" />
</p>
...
- **27,000+ 真题**：涵盖行测六大模块，支持自定义导入题库 JSON
...
- **白噪音**：内置雨声、咖啡厅、森林三种环境音
- **任务绑定**：将番茄钟与学习计划关联，追踪专注时长

### 名师模式

- **多教师支持**：内置番茄等名师解题风格，可自定义导入教师配置
- **7 种题型适配**：片段阅读、逻辑填空、语句表达、图形推理、定义判断、类比推理、逻辑判断
